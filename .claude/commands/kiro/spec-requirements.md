...
- Current requirements: `docs/.kiro/specs/$1/requirements.md`
...
Update requirements.md with complete content in the language specified in spec.json (check `docs/.kiro/specs/$1/spec.json` for "language" field):
