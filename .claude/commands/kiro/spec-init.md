...
**Check existing `docs/.kiro/specs/` directory to ensure the generated feature name is unique. If a conflict exists, append a number suffix (e.g., feature-name-2).**

### 2. Create Spec Directory
Create `docs/.kiro/specs/{YYYY-MM-DD}-{generated-feature-name}/` directory with:
...
```json
{
  "feature_name": "{YYYY-MM-DD}-{generated-feature-name}",
