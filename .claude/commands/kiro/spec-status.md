...
### Spec Files
- Spec directory: !`ls -la docs/.kiro/specs/$1/`
...
### All Specs Overview
- Available specs: !`ls -la docs/.kiro/specs/`
- Active specs: !`find docs/.kiro/specs/ -name "spec.json" -exec grep -l "implementation_ready.*true" {} \;`

## Task: Generate Status Report

Create comprehensive status report for the specification in the language specified in spec.json (check `docs/.kiro/specs/$1/spec.json` for "language" field):
