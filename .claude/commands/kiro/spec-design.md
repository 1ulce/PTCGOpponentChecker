...
- **Context Loading**: Read `docs/.kiro/specs/$1/requirements.md`, core steering documents, and existing design.md (if merge mode)
...
- Verify alignment with core steering documents (`structure.md`, `tech.md`, `product.md`) and any custom steering files
  - **Core steering**: @docs/.kiro/steering/structure.md, @docs/.kiro/steering/tech.md, @docs/.kiro/steering/product.md
  - **Custom steering**: All additional `.md` files in `docs/.kiro/steering/` directory (e.g., `api.md`, `testing.md`, `security.md`)
