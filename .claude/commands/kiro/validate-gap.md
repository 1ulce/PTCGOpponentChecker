...
### Steering Context
- Architecture context: @docs/.kiro/steering/structure.md
- Technical constraints: @docs/.kiro/steering/tech.md
- Product context: @docs/.kiro/steering/product.md
- Custom steering: Load all "Always" mode custom steering files from docs/.kiro/steering/

### Existing Spec Context
- Current spec directory: !`ls -la docs/.kiro/specs/$1/`
- Requirements document: @docs/.kiro/specs/$1/requirements.md
- Spec metadata: @docs/.kiro/specs/$1/spec.json

## Task: Implementation Gap Analysis

### Prerequisites
- Requirements document must exist: `docs/.kiro/specs/$1/requirements.md`
...
Generate analysis in the language specified in spec.json (check `docs/.kiro/specs/$1/spec.json` for "language" field):
