...
- Design document must exist: `docs/.kiro/specs/$1/design.md`
...
- Design document: @docs/.kiro/specs/$1/design.md
- Core steering documents:
  - Architecture: @docs/.kiro/steering/structure.md
  - Technology: @docs/.kiro/steering/tech.md
  - Product context: @docs/.kiro/steering/product.md
- Custom steering: All additional `.md` files in `docs/.kiro/steering/` directory
...
Generate review in the language specified in spec.json (check `docs/.kiro/specs/$1/spec.json` for "language" field):
